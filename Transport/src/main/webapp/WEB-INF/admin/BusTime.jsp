...
<head>
    ...
    <link href="${path}/lib/layui/css/layui.css" rel="stylesheet"  media="all"/>
	<script type="text/javascript" src="${path}/js/jquery.min.js"></script>
	<script type="text/javascript" src="${path}/lib/layui/layui.js"></script>
	<script type="text/javascript" src="${path}/lib/layui/lay/modules/jquery.js"></script>
	<script type="text/javascript" src="${path}/lib/layui/lay/modules/layer.js"></script>
	<script type="text/javascript" src="${path}/lib/layui/lay/modules/form.js"></script>
	<script type="text/javascript" src="${path}/lib/layui/layui.all.js"></script>
	<style>
		#div1{
			margin-top: 10px;
			width: 90%;
